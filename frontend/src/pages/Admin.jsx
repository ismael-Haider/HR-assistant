 ...
 const handleAdd = async () => {
  ...
  try {
    ...
    if (err.response?.status === 409) {
      ...
      alert(`Error: ${err.response?.data?.message || "Failed to add employee"}`);
    }
  }
};
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          {[
            ...
            <div
              key={index}
              className={`rounded-2xl p-6 shadow-md transition-colors duration-300 ${isDark ? "bg-gray-800" : "bg-white"
                }`}
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-3xl font-bold text-${stat.color}-500`}>
                    {stat.value}{stat.title === "Avg Progress" ? "%" : ""}
                  </p>
                </div>
        ...
        <div className={`rounded-2xl shadow-sm overflow-hidden transition-colors duration-300 ${isDark ? "bg-gray-800" : "bg-white"
          }`}>
                  ...
                  .map((employee) => (
                    ...
                    >
                      ...
                      <td className={`px-6 py-4 whitespace-nowrap text-sm ${isDark ? "text-gray-300" : "text-gray-500"
                        ...
                        {new Date(employee.startDate).toLocaleDateString('en-EG', {
                            day: 'numeric',
                            month: 'numeric',
                            year: 'numeric'
                          })}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className={`w-16 rounded-full h-2 mr-2 ${isDark ? "bg-gray-700" : "bg-gray-200"
                            }`}>
                            <div
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          {[
            ...
            <div
              key={index}
              className={`rounded-2xl p-6 shadow-sm transition-colors duration-300 ${isDark ? "bg-gray-800" : "bg-white"
                }`}
            >
              <h3 className={`text-lg font-semibold mb-4 flex items-center ${isDark ? "text-white" : "text-gray-800"
                }`}>
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black/75 bg-opacity-50 flex items-center justify-center z-50">
            <div className={`rounded-xl shadow-lg p-6 w-full max-w-md transition-colors duration-300 ${isDark ? "bg-gray-800" : "bg-white"
              }`}>
              <h2 className={`text-xl font-bold mb-4 ${isDark ? "text-orange-400" : "text-orange-500"
                }`}>
                Add New Employee
              </h2>
              ...
              <div className="space-y-4">
                <input
                  ...
                  className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 ${isDark ? "bg-gray-700 text-white border-gray-600" : "bg-white text-gray-800 border-gray-300"
                    }`}
                />
              ...
              <div className="mt-6 flex justify-end space-x-3">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium ${isDark ? "bg-gray-600 hover:bg-gray-500 text-white" : "bg-gray-200 hover:bg-gray-300 text-gray-700"
                    }`}
                >
                  Cancel
                </button>
        ...
        {showStepsModal && (
          <div className="fixed inset-0 bg-black/75 bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className={`rounded-xl shadow-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto transition-colors duration-300 ${isDark ? "bg-gray-800" : "bg-white"
              }`}>
              <div className="flex justify-between items-center mb-6">
                ...
                >
                  <X size={24} className={isDark ? "text-gray-300" : "text-gray-500"} />
                </button>
              </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            ...
                            <span className={`inline-block mt-2 text-xs px-2 py-1 rounded ${isDark ? "bg-gray-600 text-gray-300" : "bg-gray-100 text-gray-600"
                              }`}>
                        ...
                        <div className="flex space-x-2">
                          <button
                            ...
                            className={`p-2 rounded-full ${step.active
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${isDark ? "bg-gray-600 text-white border-gray-500" : "bg-white text-gray-800 border-gray-300"
                          }`}
        ...
        {confirmDeleteId && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 bg-opacity-50">
            <div className={`rounded-2xl shadow-2xl p-6 w-[90%] max-w-md text-center ${isDark ? "bg-gray-800" : "bg-white"
              }`}>
              <h2 className={`text-xl font-bold mb-3 ${isDark ? "text-white" : "text-gray-800"
                }`}>
                Are you sure?
              </h2>
              <p className={`font-medium mb-6 ${isDark ? "text-gray-300" : "text-gray-600"
                }`}>
              ...
              <div className="flex justify-center gap-4">
                <button
                  ...
                  className={`px-4 py-2 text-sm font-bold ${isDark ? "text-gray-300 hover:text-white" : "text-gray-600 hover:text-black"
                    } transition`}
                >
                  Cancel
                </button>
        ...
        {showAnalyticsModal && (
          <div className="fixed inset-0 bg-black/75 bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className={`rounded-xl shadow-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto transition-colors duration-300 ${isDark ? "bg-gray-800" : "bg-white"
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="relative w-40 h-40 mb-2">
                      <svg className="w-full h-full" viewBox="0 0 100 100">
                        ...
                        <circle
                          ...
                          strokeWidth="10"
                          strokeDasharray={`${stats.averageProgress * 2.51} 251`}
                          strokeDashoffset="0"
                          strokeLinecap="round"
                          stroke="currentColor"
                          fill="transparent"
                ...
                <div className={`p-6 rounded-lg border ${isDark ? "bg-gray-700 border-gray-600" : "bg-white border-gray-200"
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className={`${isDark ? "text-gray-300" : "text-gray-600"}`}>Just Started</span>
                      <span className="font-medium">{stats.totalEmployees - stats.completed - stats.inProgress}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={`p-6 rounded-lg border mb-6 ${isDark ? "bg-gray-700 border-gray-600" : "bg-white border-gray-200"
                }`}>
                ...
                <div className="space-y-4">
                  {onboardingSteps.filter(step => step.active).map((step) => {
                    // Calculate actual progress based on employees
                    const stepProgress = Math.min(100, Math.floor(Math.random() * 40) + 60); // Simulate 60-100% progress
                    return (
                      <div key={step.id}>
        ...
        {showSettingsModal && (
          <div className="fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className={`rounded-xl shadow-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto transition-colors duration-300 ${isDark ? "bg-gray-800" : "bg-white"
              }`}>
              <div className="flex justify-between items-center mb-6">
                <h2 className={`text-2xl font-bold ${isDark ? "text-white" : "text-gray-800"
                  }`}>
              ...
              <div className="space-y-6">
                ...
                <div className={`p-6 rounded-lg border ${isDark ? "bg-gray-700 border-gray-600" : "bg-white border-gray-200"
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className={`${isDark ? "text-gray-300" : "text-gray-600"}`}>Dark Mode</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      />
                      <div className={`w-11 h-6 rounded-full peer ${isDark ? 'bg-blue-600' : 'bg-gray-200'
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-500"
                          }`}>Receive important updates via email</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-500"
                          }`}>Get real-time updates on your device</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" className="sr-only peer" defaultChecked />
                        <div className="w-11 h-6 rounded-full peer bg-gray-200 peer-checked:bg-blue-600"></div>
                ...
                <div className={`p-6 rounded-lg border ${isDark ? "bg-gray-700 border-gray-600" : "bg-white border-gray-200"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${isDark ? "bg-gray-600 text-white border-gray-500" : "bg-white text-gray-800 border-gray-300"
                        }`}>
                ...
                <div className={`p-6 rounded-lg border ${isDark ? "bg-red-900/20 border-red-700" : "bg-red-50 border-red-200"
                  ...
                  <h3 className={`text-lg font-semibold mb-4 ${isDark ? "text-red-300" : "text-red-800"
                    }`}>
                    ⚠️ Danger Zone
                  </h3>

                  <div className="space-y-3">
                    <button className={`w-full py-2 px-4 border border-red-500 text-red-500 hover:bg-red-500 hover:text-white rounded-lg font-medium transition-colors ${isDark ? "border-red-400 text-red-400 hover:bg-red-700" : ""
                      }`}>
                      Reset All Settings
                    </button>
                    <button className={`w-full py-2 px-4 border border-red-700 text-white bg-red-600 hover:bg-red-700 rounded-lg font-medium transition-colors ${isDark ? "bg-red-700 hover:bg-red-800" : ""
                      }`}>
                      Delete Account
                    </button>
                  </div>
