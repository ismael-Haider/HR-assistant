...
const Step = () => {
  ...
  useEffect(() => {
    ...
    if (stepContent[stepId]?.type === 'tools') {
      setToolsSetup(Array(stepContent[stepId].content.tools.length).fill(false));
    }
    if (stepContent[stepId]?.type === 'checklist') {
      setTasksCompleted(Array(stepContent[stepId].content.tasks.length).fill(false));
    }
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.button
              ...
              whileHover={(!isCompleting && isStepCompleted) ? { scale: 1.03 } : {}}
            ...
            >
              {isCompleting ? (
                ...
                <>
                  <span>{stepId === '1' ? 'Complete Step' : 'Mark as Completed'}</span>
